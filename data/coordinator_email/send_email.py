...
recipients = [receiver_email,'noreply@kumc.edu']
#recipients = [receiver_email]

msg2email = MIMEMultipart('related')
msg2email["Subject"] = "COMET Coordinator Email"
...
text = """\
If you see this please contact noreply@kumc.edu and let the LEAP!Rx know you cannot see
