...
msg2email["Subject"] = "COMET YMCA Liason Email"
...
filename = "COMET Study Coordinator Email.html"
...
part1.set_payload(open(ymca_billing, "rb").read())
encoders.encode_base64(part1)
part1.add_header('Content-Disposition', "attachment; filename= %s" % "ymca_billing.csv")
