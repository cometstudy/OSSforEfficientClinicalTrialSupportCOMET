...
recipients = [receiver_email,'study_coordinator_2@kumc.edu','user2@kumc.edu','user4@kumc.edu']
#recipients = [receiver_email]

msg2email = MIMEMultipart('related')
msg2email["Subject"] = "[secure] COMET Scientist Email"
...
text = """\
If you see this please contact study_coordinator_2@kumc.edu and let the LEAP!Rx know you cannot see
...
filename = "COMET Scientist Email.html"
...
########## Attach dsmc report ######
dsmc_name = "dsmc_report_open.docx"
dsmc_attachment = open(dsmc, 'rb')

part2 = MIMEBase("application", "octet-stream")
part2.set_payload(dsmc_attachment.read())
encoders.encode_base64(part2)
part2.add_header('Content-Disposition', "attachment; filename= %s" % dsmc_name)
