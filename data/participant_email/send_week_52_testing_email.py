...
#Commenting out because no consent needs to be attached. Leaving commented in case we add a different file
...
msg2email["Subject"] = "COMET Week 52 Testing Reminder Email"
...
text = """\
If you see this please contact study_coordinator_2@kumc.edu and let him know you cannot see
...
######## Attach a pdf ###########
#Commented out bc don't need. See note above
